...
namespace DXC.Technology.Utilities.Tests
{
    ...
    public class BooleanTests : TestingClassBase
    {
        ...
        public void ConvertToString_DefaultFormat_Test()
        {
            ...
            this.IsTrue(resultTrue == "True", "ConvertToString should return 'True' for true value with default format");

            string resultFalse = Boolean.ConvertToString(false);
            this.IsTrue(resultFalse == "False", "ConvertToString should return 'False' for false value with default format");
        }
        ...
        public void ConvertToString_CustomFormat_Test()
        {
            ...
            this.IsTrue(resultTrue == "1", "ConvertToString should return '1' for true value with '1/0' format");

            string resultFalse = Boolean.ConvertToString(false, "1/0");
            this.IsTrue(resultFalse == "0", "ConvertToString should return '0' for false value with '1/0' format");
        }
        ...
        public void ConvertFromString_DefaultFormat_Test()
        {
            ...
            this.IsTrue(resultTrue, "ConvertFromString should return true for 'True' with default format");

            bool resultFalse = Boolean.ConvertFromString("False", BooleanFormatEnum.Boolean);
            this.IsTrue(!resultFalse, "ConvertFromString should return false for 'False' with default format");
        }
        ...
        public void ConvertFromString_CustomFormat_Test()
        {
            ...
            this.IsTrue(resultTrue, "ConvertFromString should return true for '1' with '1/0' format");

            bool resultFalse = Boolean.ConvertFromString("0", "1/0");
            this.IsTrue(!resultFalse, "ConvertFromString should return false for '0' with '1/0' format");
        }
        ...
        public void ConvertToString_InvalidCustomFormat_Test()
        {
            try
            {
                ...
                this.IsTrue(false, "ConvertToString should throw exception for invalid format");
            }
            catch (DXC.Technology.Exceptions.NamedExceptions.ToBeImplementedException)
            {
                this.IsTrue(true, "ConvertToString correctly throws exception for invalid format");
            }
        }
    }
}