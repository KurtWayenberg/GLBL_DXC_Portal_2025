...
{
    public class UnitTestSummaryResult
    {
        ...
        public void RegisterOutcome(UnitTestOutcome pUnitTestOutcome)
        {
        ...
        public void WriteSummaryResults(System.IO.StringWriter psw, int pIndent, bool pSkipDetail)
        {
            ...
            psw.Write(DXC.Technology.Utilities.String.FormatString(this.OverallStatus.ToString(), 12));
            if (!pSkipDetail)
            {
                psw.Write(" ");
                ...
                psw.Write(" ");
                psw.Write(DXC.Technology.Utilities.String.FormatString((this.TotalDurationInMilliSeconds / 1000).ToString("0.00", DXC.Technology.Utilities.StringFormatProvider.Default),
        ...
        public void WriteTestTypeResults(System.IO.StringWriter psw, int pIndent, bool pSkipDetail)
        {
            ...
            psw.Write(" ");
            psw.Write(DXC.Technology.Utilities.String.FormatString(this.OverallStatus.ToString(), 10));
            if (!pSkipDetail)
            {
                psw.Write(" ");
                psw.Write(DXC.Technology.Utilities.String.FormatString(this.TotalTestClassCount, 4));
